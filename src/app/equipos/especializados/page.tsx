...
export default function EquiposEspecializadosPage() {
  return (
    <PageSection
      title={
        <>
          Equipos <span className="text-amber-400">Especializados</span>
        </>
      }
    >
      <p className="text-lg text-stone-300 mb-12 max-w-3xl mx-auto text-center">
        Además de la maquinaria pesada, disponemos de equipos especializados
        para tareas específicas que requieren precisión y alta tecnología.
      </p>
      <div className="grid md:grid-cols-2 gap-8">
        <EquipmentSpecCard
          name="Perforadora de Rocas"
          specs={[
            "Profundidad: Hasta 30m",
            "Diámetro: 76-152 mm",
            "Aplicación: Minería, Construcción",
          ]}
          image="/images/equipos/perforadora.webp"
        />
        <EquipmentSpecCard
          ...
          specs={[
            "Precisión: Alta",
            "Seguridad: Máxima",
            "Aplicación: Demoliciones, Minería",
          ]}
          image="/images/equipos/voladura.webp"
        />
      </div>
    </PageSection>
  );
