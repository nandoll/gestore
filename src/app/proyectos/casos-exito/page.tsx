  ...
  <div className="bg-stone-800 rounded-lg shadow-lg p-6 flex flex-col md:flex-row items-center md:items-start gap-8 border border-stone-700">
    ...
    <div className="md:flex-grow">
      ...
      <p className="text-stone-300 mb-2">
        <span className="font-bold text-amber-400">Desafío:</span> {challenge}
      </p>
      <p className="text-stone-300 mb-2">
        <span className="font-bold text-amber-400">Solución:</span> {solution}
      </p>
      <p className="text-stone-300">
        <span className="font-bold text-amber-400">Resultados:</span> {results}
      </p>
    </div>
  </div>
);
...
export default function CasosExitoPage() {
  return (
    <PageSection
      title={
        <>
          Casos de <span className="text-amber-400">Éxito</span>
        </>
      }
    >
      <p className="text-lg text-stone-300 mb-12 max-w-3xl mx-auto text-center">
        Nuestros casos de éxito demuestran nuestra capacidad para superar
        desafíos y entregar resultados excepcionales en proyectos complejos.
      </p>
      <div className="space-y-12">
        <SuccessStoryCard
          ...
          image="/images/caso-exito/caso-exito-1.webp"
        />
        <SuccessStoryCard
          ...
          image="/images/caso-exito/caso-exito-2.webp"
        />
      </div>
    </PageSection>
  );
