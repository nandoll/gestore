...
const projectSections = [
  {
    title: "Obras Civiles",
    description: "Proyectos de infraestructura vial, edificación y desarrollo urbano con los más altos estándares.",
    image: "/images/slide_7.png",
    href: "/proyectos/obras-civiles",
  },
  {
    title: "Proyectos Mineros",
    description: "Soluciones innovadoras para el sector minero, desde la extracción hasta la gestión ambiental.",
    image: "/images/slide_6.png",
    href: "/proyectos/proyectos-mineros",
  },
  {
    title: "Casos de Éxito",
    description: "Historias detalladas de cómo hemos resuelto desafíos complejos para nuestros clientes.",
    ...
    <section className="py-20 bg-stone-900">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-stone-400">
          Explora nuestra cartera de proyectos exitosos en obras civiles y minería.
        </p>
